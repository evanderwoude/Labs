...
definitions):\begin{parts}
  \part \mintinline{text}{kill}: 
    \begin{solution}[1cm]
    \end{solution}  \part \mintinline{text}{break}:     \begin{solution}[1cm]
    \end{solution}  \part \mintinline{text}{step}:    \begin{solution}[1cm]
    \end{solution}  \part \mintinline{text}{next}:     \begin{solution}[1cm]
    \end{solution}  \part \mintinline{text}{continue}:     \begin{solution}[1cm]
    \end{solution}  \part \mintinline{text}{print}:     \begin{solution}[1cm]
    \end{solution}\end{parts}
